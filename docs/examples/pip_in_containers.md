*Note that this is not a recommended approach. Please read [singularity.md#installing-software-in-containers](../singularity.md#installing-software-in-containers) first,
